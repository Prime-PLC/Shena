...
<section style="padding:56px 0;background:#F7F7F9;border-top:1px solid #E5E7EB;border-bottom:1px solid #E5E7EB;"><div class="container"><div class="row align-items-center g-0"><div class="col-lg-5 pe-lg-5 pb-4 pb-lg-0"><span style="color:#7F3D9E;font-weight:700;letter-spacing:1.4px;">SHENA BASIC</span><p style="color:#2D1A4A;font-family:'Playfair Display',serif;font-size:1.45rem;line-height:1.3;margin:10px 0;">Your primary welfare cover during unforeseen times.</p><p style="color:#6B7280;line-height:1.7;margin:0;">SHENA BASIC is our primary welfare cover during unforeseen eventualities. We support our members and their loved ones with funeral services.</p></div><div class="col-lg-5 px-lg-5 py-4 py-lg-0" style="border-left:1px solid #D9D3DF;"><span style="color:#7F3D9E;font-weight:700;letter-spacing:1.4px;">SHENA PLATINUM</span><p style="color:#2D1A4A;font-family:'Playfair Display',serif;font-size:1.45rem;line-height:1.3;margin:10px 0;">Extra hospital support when you need it.</p><p style="color:#6B7280;line-height:1.7;margin:0;">SHENA PLATINUM provides inpatient support for members and their loved ones. It is a complimentary service to SHENA BASIC. It pays for daily bed charges for members and their dependants.</p></div><div class="col-lg-2 text-lg-end pt-4 pt-lg-0 ps-lg-4"><a href="/membership#platinum" class="btn" style="background:#7F3D9E;color:#fff;margin-bottom:10px;">Compare covers</a><a href="/services#platinum" style="color:#7F3D9E;font-weight:600;display:block;">See services</a></div></div></div></section>
